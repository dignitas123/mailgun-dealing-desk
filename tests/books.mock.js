...
exports.deletedCount = exports.deleteOne = exports.update = exports.createError = exports.create = exports.findError = exports.find = exports.castError = exports.findOne = void 0;
exports.findOne = {
...
exports.castError = new Error('Cast to number failed for value "NaN" at path "id" for model "Books"');
exports.find = [
    {
        _id: "5dff58da85eb210f0aac43af",
        name: "深入浅出Node.js",
...
exports.findError = new Error("test find error");
exports.create = {
...
exports.createError = new Error("E11000 duplicate key error collection: study1.books index: id_1 dup key: { id: 30247892 }");
exports.update = {
    _id: "5eb0023e6460b01a9461c8fc",
    name: "Node.js：来一打 C++ 扩展",
    id: 30247892,
